module example.com/fanone/services/interaction

go 1.25.3

require (
	example.com/fanone/gen-rpc v0.0.0
	example.com/fanone/work5 v0.0.0
...
replace example.com/fanone/gen-rpc => ../../gen/rpc

replace example.com/fanone/work5 => ../..
